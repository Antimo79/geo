package it.datamanagement.akropolis.contabilita.utenze.geo.config;

import it.datamanagement.akropolis.contabilita.utenze.geo.security.OAuth2AuthenticationSuccessHandler;
