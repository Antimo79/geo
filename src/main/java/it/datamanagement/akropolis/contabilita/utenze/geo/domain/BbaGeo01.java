package it.datamanagement.akropolis.contabilita.utenze.geo.domain;
...
public class BbaGeo01 implements Serializable {
    ...
    public BbaGeo02Cl getIdClasse() {
        return idClasse;
    }

    public BbaGeo01 idClasse(BbaGeo02Cl bbaGeo02Cl) {
        this.idClasse = bbaGeo02Cl;
        return this;
    }

    public void setIdClasse(BbaGeo02Cl bbaGeo02Cl) {
        this.idClasse = bbaGeo02Cl;
    }
