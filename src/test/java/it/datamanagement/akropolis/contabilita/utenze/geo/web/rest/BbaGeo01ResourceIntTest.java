...
import it.datamanagement.akropolis.contabilita.utenze.geo.repository.BbaGeo01Repository;
import it.datamanagement.akropolis.contabilita.utenze.geo.service.BbaGeo01Service;
...
import static it.datamanagement.akropolis.contabilita.utenze.geo.web.rest.TestUtil.createFormattingConversionService;
...
public class BbaGeo01ResourceIntTest {
    ...
    public static BbaGeo01 createEntity(EntityManager em) {
        ...
        // Add required entity
        BbaGeo02Cl bbaGeo02Cl = BbaGeo02ClResourceIntTest.createEntity(em);
        em.persist(bbaGeo02Cl);
        em.flush();
        bbaGeo01.setIdClasse(bbaGeo02Cl);
        return bbaGeo01;
    }
